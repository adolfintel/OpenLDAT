...
#define FIRMWARE_VERSION F("20230321")        //firmware version as ASCII string
#define PROTOTYPE                             //when defined, marks this device as a prototype
#define MIN_APP_VERSION 2                     //minimum versioncode of the PC driver/app required to use this device
